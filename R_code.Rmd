...
m.c <- 
  ...
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "Control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[2],2)),       # ! issue with R² marg. calculation, replaced with R² conditional in the meantime
...
m.m <- 
  ...
  scale_x_log10(breaks = seq(0, 30, 5), limits = c(3.8, 30.1)) +
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "Control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[4],2)), # ! issue with R² marg. calculation, replaced with R² conditional in the meantime
            hjust = 1.015, vjust = 1.5, col = "Black") 
...
m.w <- 
  ...
  scale_x_log10(breaks = seq(0, 30, 5), limits = c(3.8, 30.1)) +
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "Control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[6],2)),  # ! issue with R² marg. calculation, replaced with R² conditional in the meantime
            hjust = 1.015, vjust = 1.5, col = "Black") 
...
f.c <- 
  ...
  scale_x_log10(breaks = seq(0, 30, 5), limits = c(3.8, 30.1)) +
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "Control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[1],2)),      # ! issue with R² marg. calculation, replaced with R² conditional in the meantime
            hjust = 1.015, vjust = 1.5, col = "Black") +
  geom_text(data = data.frame(Wing = 3.9, Weight = Inf, Treatment = "Control"),
...
f.m <- 
  ...
  scale_x_log10(breaks = seq(0, 30, 5), limits = c(3.8, 30.1)) +
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "Control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[3],2)),
            hjust = 1.015, vjust = 1.5, col = "Black") 
...
f.w <- 
  ...
  scale_x_log10(breaks = seq(0, 30, 5), limits = c(3.8, 30.1)) +
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "Control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[5],2)), 
            hjust = 1.015, vjust = 1.5, col = "Black") 
...
g2_pred <- ggplot(mod_gr, aes(x = x, y = predicted)) +
    ...
    theme(legend.position="none", 
          ...
          axis.ticks.x = element_blank(),
          axis.text = element_text(size=12),
        axis.title.y = element_text(size=20, margin =  unit(c(0, 5, 0, 5), "mm")),
          plot.margin = margin(0, 0, 0, 0, "cm")) 
  # scale_y_continuous(breaks = seq(0, 0.6, 0.1), limits = c(-0.06, 0.64))
```
...
## Bloodchemistry data
## -----------------------------------------------------------------------------
A + B + C + plot_spacer() + D + E + F + G + H + I + J + K
