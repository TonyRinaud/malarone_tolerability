...
m.c <- 
  ...
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[2],2)),
...
m.m <- 
  ...
  scale_x_log10(breaks = seq(0, 30, 5), limits = c(3.8, 30.1)) +
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[4],2)),
            hjust = 1.015, vjust = 1.5, col = "Black") 
...
m.w <- 
  ...
  scale_x_log10(breaks = seq(0, 30, 5), limits = c(3.8, 30.1)) +
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[6],2)),
            hjust = 1.015, vjust = 1.5, col = "Black") 
...
f.c <- 
  ...
  scale_x_log10(breaks = seq(0, 30, 5), limits = c(3.8, 30.1)) +
  geom_text(data = data.frame(Wing = Inf, Weight = Inf, Treatment = "control"),
            label = paste("R² (cond.)=", round(models$R2_conditional[1],2)), 
            hjust = 1.015, vjust = 1.5, col = "Black") +
  geom_text(data = data.frame(Wing = 3.9, Weight = Inf, Treatment = "control"),
